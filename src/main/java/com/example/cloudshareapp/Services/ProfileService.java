...
import com.example.cloudshareapp.Repository.ProfileRepository;
...
public class ProfileService {
    ...
    public  boolean existsByClerkId(String cleckId){
        return profileRepository.existsByClerkId(cleckId);
